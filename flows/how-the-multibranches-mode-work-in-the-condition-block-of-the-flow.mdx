...
<Accordion title="Customer Custom Fields">
...
<Accordion title="By Product from event">
...
<Accordion title="By Product segment from event">
...
<Accordion title="By Product Category from Event">
...
<Accordion title="By Product Custom Fields from Event">
...
<Accordion title="Product viewed in Session">
...
<Accordion title="Product segment viewed in Session">
...
<Accordion title="Category of Product viewed in Session">
...
<Accordion title="Custom Field of Browsed Product in Session">
...
<Accordion title="Product in Order">
...
<Accordion title="Product Segment in Order">
...
<Accordion title="Product Category in Order">
...
<Accordion title="Touchpoint of first action with Order">
...
<Accordion title="Product Custom Fields in Order">
...
<Accordion title="Order Custom field">
...
<Accordion title="By customer action">
...
<Accordion title="By action touchpoint">
...
<Accordion title="By action custom field">
