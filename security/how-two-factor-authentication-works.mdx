...
Two-factor authentication (2FA) **is not available** for projects using [Single Sign-On (SSO)](/security/single-sign-on-sso) or access via [passkeys](/security/what-are-passkeys).
