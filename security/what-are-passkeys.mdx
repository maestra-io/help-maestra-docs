...
- **In password managers:** 1Password, Dashlane, Bitwarden, and others — allowing you to use passkeys across any of your devices.[Learn more](https://help.maestra.io/en/articles/12821109-passkey-login-administration-and-setup)If a team member loses access to all devices where their passkeys are stored, the project owner, administrator, or another user with the appropriate permissions can restore their access.
