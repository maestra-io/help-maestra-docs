...
For instance, to display the [custom field](/api-integrations/how-to-create-a-custom-field) **Favorite color**: choose the base parameter (Recipient), then a group of custom fields (AdditionalData), and only then the name of this custom field (which is Color in our case).
