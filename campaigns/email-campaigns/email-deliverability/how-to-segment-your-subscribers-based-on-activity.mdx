...
If you have access to at least one year’s worth of data on your customers’ orders and actions, you can automatically create [RFM segments](/segments/how-does-rfm-segmentation-work) and add email activity/engagement to the segmentation criteria — this will create more advanced segments.
