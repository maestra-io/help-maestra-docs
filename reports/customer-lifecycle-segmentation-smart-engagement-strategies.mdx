...
| **New – 1 order** | Just made their first purchase | **Registered** ≤ 30 days ago **1 order**Last order ≤ 30 days ago |
...
- Hover over a segment name to see a tooltip with exact thresholds. Click the link to view the filter setup. ​ <img src="/images/imported/img-d28dd9fc.png" />
...
- Set up A/B tests _Disclaimer: This guide is based on real-world client cases across various industries. The results you get may depend on the business model and how well the campaign is executed._