...
A number with more than two decimal places was entered into a “Decimal” [custom field](https://help.maestra.io/en/articles/11900218-how-to-create-a-custom-field).

The enum value contains invalid characters: |. The enum value contains invalid characters: |.

A multi-value is being passed into an enum-type [custom field](https://help.maestra.io/en/articles/11900218-how-to-create-a-custom-field), but the 'Allow multiple values in one field' checkbox isn’t enabled.
