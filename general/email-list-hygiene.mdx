...
3. 	A lower domain reputation, [blacklisted IP addresses](https://intercom.help/maestraio/en/articles/11909164-what-ips-does-maestra-use-to-send-emails), and lower deliverability rate if the email falls into a spam trap.
...
You will want to clean your email list **before** you send your first email campaign using Maestra, otherwise you risk damaging your domain reputation, lowering your deliverability rate, and getting your [IPs blocked](https://intercom.help/maestraio/en/articles/11909164-what-ips-does-maestra-use-to-send-emails).
...
You can read more about importing contacts in [this article](https://intercom.help/maestraio/en/articles/11840796-how-to-bulk-import-customers-from-a-file).
