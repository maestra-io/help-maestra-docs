...
The system supports different methods depending on the data types used by variables. To learn more about campaign variables, please see [this article.](https://intercom.help/maestraio/en/articles/11899281-what-is-the-message-template-engine)
...
- **TableRows** (collection, quantity of columns): transforms a collection of elements into a set of rows with cells. This can then help create HTML tables.  For more information, please refer to [this article.](https://intercom.help/maestraio/en/articles/11909592-how-use-variables-to-create-a-product-grid-layout-for-html)
