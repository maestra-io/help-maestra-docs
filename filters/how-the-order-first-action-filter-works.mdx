...
[Orders](https://help.maestra.io/en/articles/11843001-what-is-an-order) often go through several statuses (e.g., placed → paid → delivered). The exact set of statuses may vary by project. 
