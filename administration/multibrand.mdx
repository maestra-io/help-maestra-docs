...
- Predictive AI: Next Best ActionTo segment customers by brand for flows triggered by exception events, add Condition blocks and set the filter to the required brand.
