...
At the integration stage, [a custom field](https://intercom.help/maestraio/en/articles/11900218-how-to-create-a-custom-field) is created in the Maestra system (e.g. entity: Order, field type: External ID).
